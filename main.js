...
global.authFile = `QueenNethuSession`
...
return { conversation: "hello, i'm mr.shadow" }},   
msgRetryCounterMap,
logger: pino({ level: 'silent' }),
auth: state,
browser: ['QueenNethuBot','Shadow','9.7.0'],
version   
}
...
const directories = ['./QueenNethuSession/', './jadibts/']
...
if (connection == 'open') {
console.log(chalk.yellow('▣──────────────────────────────···\n│\n│❧ 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝙳𝙾 𝙲𝙾𝚁𝚁𝙴𝙲𝚃𝙰𝙼𝙴𝙽𝚃𝙴 𝙰𝙻 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 ✅\n│\nӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁӁ···'))}
if (connection == 'close') {
...
console.log(chalk.cyanBright(`\n▣────────[ AUTO_PURGE_SESSIONS_Queen Nethu-BOTS ]───────────···\n│\n▣─❧ ARCHIVOS ELIMINADOS ✅\n│\n▣────────────────────────────────────···\n`))
}, 1000 * 60 * 60)
setInterval(async () => {
    await purgeOldFiles()
...
let bio = `🤖 ᴅᴇᴠᴏʟᴏᴘ: ${uptime} ┃ 👑 ʙʏ ᴍʀ.ʜᴀɴꜱᴀᴍᴀʟᴀ & ᴍꜱ.ɴᴇᴛʜᴜ┃ 🔗 ʙᴏᴛ ɴᴀᴍᴇ: Qᴜᴇᴇɴ ɴᴇᴛʜᴜ ʙᴏᴛ`
